...
$count=1;
$sq="select * from testi order by id desc ";
...
$pro_id=$row['id'];
	echo "	<tr>
								  ...
								  <td>".$row['des']."</td>
								   ...
								   <td><a href='edit_testi.php?id=$pro_id' class='label label-info'>Edit</a>
								  <a href='delete_testi.php?id=$pro_id' class='label label-danger' onclick='return send();'>Delete</a>
								 </td>
								</tr>";
